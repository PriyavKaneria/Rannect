defmodule RannectWeb.UserAuthTest do
  use RannectWeb.ConnCase, async: true

  alias Rannect.Users
  alias RannectWeb.UserAuth
  import Rannect.UsersFixtures

  @remember_me_cookie "_rannect_web_user_remember_me"

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, RannectWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      RannectWeb.Endpoint.subscribe(live_socket_id)
